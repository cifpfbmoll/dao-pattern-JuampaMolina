...
public class FruitResourceTest {
    ...
    public void testList() {
        given().contentType(ContentType.JSON).when().get("/fruits").then().statusCode(200).body("$.size()", is(2),
                "name", containsInAnyOrder("Strawberry", "Orange"), "description",
    ...
    public void addDeleteFruitTest() {
        ...
        given().contentType(ContentType.JSON).when().delete("/fruits/Watermelon").then().statusCode(200).body("name",
                equalTo("Watermelon"));
